...
If you are using Iono Pi with Raspberry Pi **4** and a **32-bit** OS, add to `/boot/firmware/config.txt` the following line: [[why?](https://github.com/raspberrypi/firmware/issues/1795)]
